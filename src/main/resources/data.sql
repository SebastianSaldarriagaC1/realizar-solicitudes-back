INSERT INTO conductor (nombre, celular, email, cedula, rol, id_tipo_usuario, nro_servicios, vehiculo_placa, vehiculo_marca, vehiculo_modelo) VALUES
('Juan', '3001112233', 'juan@email.com', '12345678', 'CONDUCTOR', 1, 10, 'ABC-123', 'Toyota', 'Corolla'),
('Maria', '3001112234', 'maria@email.com', '12345679', 'CONDUCTOR', 2, 12, 'ABC-124', 'Honda', 'Civic'),
('Pedro', '3001112235', 'pedro@email.com', '12345680', 'CONDUCTOR', 1, 15, 'ABC-125', 'Ford', 'Focus'),
('Laura', '3001112236', 'laura@email.com', '12345681', 'CONDUCTOR', 2, 8, 'ABC-126', 'Chevrolet', 'Malibu'),
('Carlos', '3001112237', 'carlos@email.com', '12345682', 'CONDUCTOR', 1, 9, 'ABC-127', 'Nissan', 'Altima');
